  ...
  return (
    ...
    >
      <motion.p
        ...
        className="cursor-pointer text-foreground font-medium text-base lg:text-xl whitespace-nowrap hover:opacity-[0.9] hover:text-accent py-1"
      >
        {element}
      </motion.p>
      {selected !== null && (
          ...
          {selected === element && (
            <div className="absolute top-[calc(100%_+_0.5rem)] left-1/2 transform -translate-x-1/2 z-50">
              <motion.div
                transition={springTransition}
                layoutId="selected"
                className="dropdown-content bg-card/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-border shadow-2xl"
                style={{
...
export const HoverLink: React.FC<HoverLinkProps> = ({ url, children, onPress }) => {
  return (
    <a
      href={url}
      onClick={onPress}
      className="block px-4 py-2 hover:bg-secondary rounded-lg text-muted-foreground hover:text-foreground transition-colors"
    >
      {children}
    </a>
  );
  ...
  return (
    ...
    <div className={`sticky top-0 z-50 w-full ${styleName}`}>
      ...
      <div className="hidden md:block">
        ...
        <div className="relative w-full max-w-7xl mx-auto h-24 flex items-center justify-between px-4 lg:px-10">
          ...
          <motion.div
            ...
            className="bg-card/80 backdrop-blur-sm text-foreground px-4 lg:px-8 py-3 lg:py-4 rounded-full font-semibold text-lg lg:text-xl z-10 flex-shrink-0"
          ...
          <motion.nav
            ...
            className="bg-card/80 backdrop-blur-sm rounded-full flex items-center justify-center gap-6 lg:gap-12 z-10 flex-shrink-0"
                ...
                {element.submenu ? (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="text-foreground font-medium text-base lg:text-xl whitespace-nowrap hover:text-accent transition-colors py-1"
          ...
          <motion.div
            ...
            className="bg-card/80 backdrop-blur-sm rounded-full p-2 lg:p-3 z-10 flex-shrink-0 flex items-center gap-2 lg:gap-3"
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="0%" stopColor="#BD9452" stopOpacity="0" />

                <stop offset="50%" stopColor="#BD9452" stopOpacity="1" />

                <stop offset="100%" stopColor="#BD9452" stopOpacity="0" />
      ...
      <div className="block md:hidden">
        ...
        <div className="top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 relative">
          ...
          <div className="container flex h-16 max-w-screen-2xl items-center px-4">
            ...
            >
              ...
              <div className="bg-card/80 backdrop-blur-sm text-foreground px-4 py-2 rounded-full font-semibold text-base">
          ...
          <motion.div
            ...
            className="absolute left-0 right-0 top-full z-40 overflow-y-auto border-t border-border/40 bg-background/95 backdrop-blur"
                    ...
                    {element.submenu ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          className="flex items-center justify-between w-full text-foreground font-medium text-base py-2 px-4 rounded-lg hover:bg-secondary transition-colors border-b border-border"
                      ...
                      <a
                        ...
                        className="text-foreground font-medium text-base py-2 px-4 rounded-lg hover:bg-secondary transition-colors border-b border-border block"
