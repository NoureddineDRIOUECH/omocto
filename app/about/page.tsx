...
export default function About() {
  ...
  const rethinkingRef = useRef<HTMLDivElement>(null);
      ...
      `,
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold  mb-6">
              ...
              >
                {
                  "Omocto : Visibilité sur mesure grâce aux relations médias et à l'influence numérique"
                }
              </VerticalCutReveal>
            </h2>
            ...
            >
              Nous sommes une agence de communication spécialisée dans les relations médias et l'influence numérique, offrant une visibilité sur mesure à nos clients.
              Créativité.
            </TimelineContent>
            ...
            >
              Découvrez nos services <ArrowRight className="" />
            </TimelineContent>
          </div>
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 place-items-center pt-20">
            {/* First Team Member */}
            <div className="text-center">
              <TimelineContent
                  ...
                  timelineRef={heroRef}
                  customVariants={revealVariants}
                  className="w-64 h-80 rounded-lg overflow-hidden mx-auto"
              ...
              <div className="mt-4">
                <h3 className="text-xl font-bold">Ouidade Melhaf</h3>
                ...
                <div className="flex justify-center gap-4 mt-2">
                  ...
                  <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-accent">
                    <Linkedin size={20} />
                  </a>
                </div>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="mt-4">
                <h3 className="text-xl font-bold">Wiame Hakim</h3>
                <p className="text-gray-400">Conseillère juridique</p>
                <div className="flex justify-center gap-4 mt-2">
                  <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-accent">
                    <Facebook size={20} />
                  </a>
        ...
        <div className="max-w-6xl mx-auto" ref={rethinkingRef}>
          <div className="flex flex-col  items-start gap-8">
            ...
            <div className="flex-1">
              ...
              >
                ...
                la manière de construire des campagnes de communication percutantes. Notre
                objectif est de placer la barre toujours plus haut et d'{" "}
                <TimelineContent
                    as="span"
                    animationNum={2}
                    timelineRef={rethinkingRef}
              ...
              <div className="mt-12 flex gap-2 justify-between">
                ...
                >
                  <div className=" font-medium  mb-1 capitalize">
                    Nous sommes Omocto et nous vous
                  </div>
                  <div className="  font-semibold uppercase">
                    emmènerons plus loin
                  </div>
                </TimelineContent>
              </div>
            </div>
